...
/** @type {string} */
const CACHE_VERSION = '1744226576|578293737';
/** @type {string} */
const CACHE_PREFIX = 'Tetris-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Teris.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Teris.html","Teris.js","Teris.offline.html","Teris.icon.png","Teris.apple-touch-icon.png","Teris.worker.js","Teris.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["Teris.wasm","Teris.pck"];
